...
/**
 * this class uses different codes to roll dice
 * for different tasks, but ultimately has the point of
 * rolling it multiple times
 */
public class DiceRoller 
{
	...
	public static void main(String[] args) 
	{
		...
		//call a string that gives 2 words so that I can 
		//combine them
		String pinkWhitney = new String ("drunk words, sober thoughts");
		
		//call a method
		starWars (pinkWhitney);
...
/**
 * this method will concat the string without any spaces
 * by replacing the space with nothing, connecting the words together
 * 
 * @param watermelon the string being used
 */
private static void starWars(String pinkWhitney) 
{
	//use the replace method to get rid of the space in the string
	String newPinkWhitney = pinkWhitney.replace(" ", "");
	//actual print statement
	System.out.println(newPinkWhitney);
